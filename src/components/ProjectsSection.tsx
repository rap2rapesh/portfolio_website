...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div 
      className="project-card rounded-xl overflow-hidden shadow-lg card-hover cursor-pointer"
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {tags.map((tag, index) => (
            <Badge 
              key={index} 
              variant="outline" 
              className="bg-portfolio-primary/5 text-portfolio-primary border-portfolio-primary/20"
            >
              {tag}
            </Badge>
          ))}
...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects" className="bg-gray-50 py-[5px]">
